...
describe("QuotesComponent", () => {
  ...
  it("should fetch data asynchronously", async () => {
    ...
    expect(quoteService.fetchQuotesFromServer()).resolves.toBe(Promise.resolve(fakedFetchedList));

    expect(quoteService.fetchQuotesFromServer()).rejects.toMatch('error');
